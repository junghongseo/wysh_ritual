...
- **Strict Fact-Based Reporting (환각 및 거짓 포장 절대 금지)**: 수집된 소스 기사의 '팩트(Fact)' 내에서만 인사이트를 도출해야 합니다. 만약 소스 기사가 특정 도시(예: 홍콩, 런던 등)를 다루지 않는 일반적인 웰니스 기사라면, 절대 그 기사의 내용을 "홍콩 금융 리더들의 트렌드"처럼 임의의 도시와 거짓으로 엮어서 지어내지(Fabrication) 마십시오. 소스에 도시 관련 내용이 없다면 일반적인 글로벌 트렌드로서만 서술해야 합니다.
